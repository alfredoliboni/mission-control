...
- Name: i-provider-portal.spec.ts >> I — Provider Portal (Phase 6) >> GET /api/provider/programs — unauthenticated returns error
- Location: tests/i-provider-portal.spec.ts:55:7
