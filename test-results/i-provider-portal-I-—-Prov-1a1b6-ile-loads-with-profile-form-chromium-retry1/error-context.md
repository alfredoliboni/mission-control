...
- Name: i-provider-portal.spec.ts >> I — Provider Portal (Phase 6) >> /portal/profile loads with profile form
- Location: tests/i-provider-portal.spec.ts:11:7
...
Expected pattern: /profile|organization/i
