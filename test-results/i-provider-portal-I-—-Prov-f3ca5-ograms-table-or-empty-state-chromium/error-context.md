...
- Name: i-provider-portal.spec.ts >> I — Provider Portal (Phase 6) >> /portal/programs loads with programs table or empty state
- Location: tests/i-provider-portal.spec.ts:20:7
...
Call log:
  ...
  - waiting for locator('body')
    14 × locator resolved to <body class="min-h-full flex flex-col font-sans">…</body>
