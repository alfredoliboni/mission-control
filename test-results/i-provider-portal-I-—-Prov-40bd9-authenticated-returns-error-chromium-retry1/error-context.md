...
- Name: i-provider-portal.spec.ts >> I — Provider Portal (Phase 6) >> GET /api/provider/families — unauthenticated returns error
- Location: tests/i-provider-portal.spec.ts:62:7
